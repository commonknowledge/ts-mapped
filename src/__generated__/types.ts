...
export type MapQuery = { __typename?: 'Query', map?: { __typename?: 'Map', name: string, config: { __typename?: 'MapConfig', markerDataSourceIds: Array<string>, membersDataSourceId: string }, folders?: Array<{ __typename?: 'Folder', id: string, name: string, notes: string, position: number }> | null, placedMarkers?: Array<{ __typename?: 'PlacedMarker', id: string, label: string, notes: string, folderId?: string | null, position: number, point: { __typename?: 'Point', lat: number, lng: number } }> | null, turfs?: Array<{ __typename?: 'Turf', id: string, label: string, notes: string, area: number, geometry: any, createdAt: any }> | null, views?: Array<{ __typename?: 'MapView', id: string, name: string, position: number, config: { __typename?: 'MapViewConfig', areaDataSourceId: string, areaDataColumn: string, areaSetGroupCode?: AreaSetGroupCode | null, excludeColumnsString: string, mapStyleName: MapStyleName, showBoundaryOutline: boolean, showLabels: boolean, showLocations: boolean, showMembers: boolean, showTurf: boolean, visualizationType?: string | null, calculationType?: string | null, colorScheme?: string | null } }> | null } | null };
...
export type MapViewConfigResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['MapViewConfig'] = ResolversParentTypes['MapViewConfig']> = {
  ...
  colorScheme?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  visualizationType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
