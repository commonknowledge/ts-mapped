...
export type DataSourcesQuery = { __typename?: 'Query', dataSources?: Array<{ __typename?: 'DataSource', id: string, name: string, recordCount?: number | null, columnDefs: Array<{ __typename?: 'ColumnDef', name: string, type: ColumnType }> }> | null };
...
export type DataSourceResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['DataSource'] = ResolversParentTypes['DataSource']> = {
  ...
  records?: Resolver<Maybe<Array<ResolversTypes['DataRecord']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MapViewConfigResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['MapViewConfig'] = ResolversParentTypes['MapViewConfig']> = {
  ...
  selectedDataSourceId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
