...
export type MapQuery = { __typename?: 'Query', map?: { __typename?: 'Map', name: string, folders?: Array<{ __typename?: 'Folder', id: string, name: string, notes: string }> | null, placedMarkers?: Array<{ __typename?: 'PlacedMarker', id: string, label: string, notes: string, folderId?: string | null, position: number, point: { __typename?: 'Point', lat: number, lng: number } }> | null, turfs?: Array<{ __typename?: 'Turf', id: string, label: string, notes: string, area: number, geometry: any, createdAt: any }> | null, views?: Array<{ __typename?: 'MapView', id: string, config: { __typename?: 'MapViewConfig', areaDataSourceId: string, areaDataColumn: string, areaSetGroupCode?: AreaSetGroupCode | null, excludeColumnsString: string, markerDataSourceIds: Array<string>, membersDataSourceId: string, mapStyleName: MapStyleName, showBoundaryOutline: boolean, showLabels: boolean, showLocations: boolean, showMembers: boolean, showTurf: boolean } }> | null } | null };
...
export type MutationResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  upsertFolder?: Resolver<Maybe<ResolversTypes['UpsertFolderResponse']>, ParentType, ContextType, RequireFields<MutationUpsertFolderArgs, 'id' | 'mapId' | 'name' | 'notes'>>;
