...
export type GeoJsonResolvers<
  ContextType = GraphQLContext,
  ParentType extends
    ResolversParentTypes["GeoJSON"] = ResolversParentTypes["GeoJSON"],
> = {
  features?: Resolver<
    Array<ResolversTypes["GeoJSONFeature"]>,
    ParentType,
    ContextType
  >;
...
export type GeoJsonFeatureResolvers<
  ContextType = GraphQLContext,
  ParentType extends
    ResolversParentTypes["GeoJSONFeature"] = ResolversParentTypes["GeoJSONFeature"],
> = {
  geometry?: Resolver<
    ResolversTypes["GeoJSONGeometry"],
    ParentType,
    ContextType
  >;
  properties?: Resolver<ResolversTypes["JSON"], ParentType, ContextType>;
  type?: Resolver<
    ResolversTypes["GeoJSONFeatureType"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GeoJsonGeometryResolvers<
  ContextType = GraphQLContext,
  ParentType extends
    ResolversParentTypes["GeoJSONGeometry"] = ResolversParentTypes["GeoJSONGeometry"],
> = {
  ...
  >;
  type?: Resolver<
    ResolversTypes["GeoJSONGeometryType"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
  createDataSource?: Resolver<
    ...
    RequireFields<
      ...
      "name" | "rawConfig" | "rawGeocodingConfig"
    >
  >;
