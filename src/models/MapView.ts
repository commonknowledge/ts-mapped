...
const baseRecordFilterSchema = z.object({
  ...
  operator: z.enum(FilterOperator).nullish(),
...
export const markerVisualisationSchema = z.object({
  ...
  displayMode: z.enum(MarkerDisplayMode).optional(),
  iconMode: z.enum(MarkerIconMode).optional(),
  iconColumn: z.string().optional(),
  sizeMode: z.enum(MarkerSizeMode).optional(),
  sizeColumn: z.string().optional(),
  sizeSortDesc: z.boolean().optional(),
  colorMode: z.enum(MarkerColorMode).optional(),
...
export const mapViewConfigSchema = z.object({
  ...
  mapStyleName: z.enum(MapStyleName),
  mapType: z.enum(MapType).optional(),
  showChoropleth: z.boolean().optional(),
  showLabels: z.boolean(),
  showLocations: z.boolean(),
  showMembers: z.boolean(),
  showTurf: z.boolean(),
  calculationType: z.enum(CalculationType).default(CalculationType.Avg),
  colorScheme: z.enum(ColorScheme).nullish(),
  reverseColorScheme: z.boolean().nullish(),
  colorMappings: z.record(z.string(), z.string()).optional(),
  colorScaleType: z.enum(ColorScaleType).optional(),
