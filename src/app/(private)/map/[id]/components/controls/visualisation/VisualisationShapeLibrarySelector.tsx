...
import { Pentagon, Globe, Map } from 'lucide-react'
...
export default function VisualisationShapeLibrarySelector() {
    ...
    const [selectedValue, setSelectedValue] = useState<AreaSetGroupCode | null>(viewConfig.areaSetGroupCode || null);
    ...
    const localityShapes: LocalityShapeItem[] = useMemo(() => {
        ...
        Object.values(AreaSetGroupCode).forEach((code) => {
            shapes.push({
                id: code.toLowerCase(),
                code: code,
                name: AREA_SET_GROUP_LABELS[code],
        ...
        return (
            ...
            >
                <div className="flex items-start gap-3">
                    {/* Icon */}
                    <div className={`w-10 h-10 bg-gradient-to-br ${item.code === null
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {item.code && (
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-gray-500">Geographic boundary data</span>
                            </div>
                        )}
                    </div>
