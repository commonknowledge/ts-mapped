 ...
 * Includes showControls (sidebar visibility), pinDropMode (pin dropping
 * interaction) and editAreaMode (area editing interaction)
 */
...
export function useMapControlsEscapeKeyEffect() {
  ...
  }, [pinDropMode, editAreaMode, setPinDropMode, setEditAreaMode]);
}
