    ...
    <Container>
      <Prose className="mx-auto">
        ...
        <p>
          ...
          https://ts-mapped.onrender.com and explains how we collect, safeguard
        ...
        <p>
          ...
          diagnostic data. Common Knowledge owns the intellectual property
          rights in the Usage Data.
        </p>
        <p>
        ...
        <p>
          ...
          termination of your Account. We will retain and use your Personal Data
        ...
        <p>
          ...
          United Kingdom, 14 and under in China, Spain, Bulgaria, Austria,
          Cyprus, Italy and Lithuania, 15 and under in Slovenia, Check Republic,
          Greece and France and 18 and under for India, Columbia, Indonesia,
          Egypt and 16 and under all other countries (“Children”).
        </p>
        <p>
