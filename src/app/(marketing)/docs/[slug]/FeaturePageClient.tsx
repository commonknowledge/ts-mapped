        ...
        <div className="flex flex-col gap-8">
          ...
          {feature.howToUse && feature.howToUse.length > 0 && (
            <div className="space-y-24">
              {feature.howToUse.map(
                (section: FeatureHowToUseSection, sectionIndex: number) => (
                  <div
                    key={sectionIndex}
                    ref={(el) => {
          ...
          <div className="sticky top-24">
            <div className="p-4">
              ...
              <nav className="space-y-2">
                {feature.howToUse.map(
                  (section: FeatureHowToUseSection, index: number) => (
                    <button
                      key={index}
