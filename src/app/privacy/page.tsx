      ...
      <div className="container">
        <div className="prose mx-auto text-foreground prose-headings:text-primary prose-headings:font-medium prose-headings:tracking-tight">
          ...
          <p>
            ...
            designers, researchers and facilitators. We work in direct
            collaboration with grassroots organisers and communities around the
            world, using our digital expertise to multiply their impact and
            capacity.
          </p>
          <p>
            Common Knowledge Cooperative Limited (“us”, “we”, or “our”) operates
            https://ts-mapped.onrender.com (hereinafter referred to as
            “Service”).
          </p>
          <p>
            Our Privacy Policy governs your visit to
            https://ts-mapped.onrender.com and explains how we collect,
          ...
          <p>
            ...
            personal data. For the purpose of this Privacy Policy, we are a Data
          ...
          <p>
            Please contact us at hello@commonknowledge.coop if you wish to make
            a request.
          </p>
          <h2>4. Information Collection and Use</h2>
          <p>
            <strong>4.1.</strong> We collect several different types of
          ...
          <p>
            ...
            these communications from us by emailing to
          ...
          <p>
            ...
            other diagnostic data. Common Knowledge owns the intellectual
            property rights in the Usage Data.
          </p>
          <p>
          ...
          <p>
            <strong>7.1.</strong> We will retain your Personal Data only for as
            long as is necessary for the purposes set out in the Agreement and
            this Privacy Policy but no more than twelve months after the
            termination of your Account. We will retain and use your Personal
          ...
          <p>
            <strong>8.1.</strong> Your consent to this Privacy Policy followed
            by your submission of such information represents your agreement to
            process the data in the United Kingdom.
          </p>
          ...
          <p>
            <strong>12.1. Sentry.</strong> Sentry is an open-source error
            tracking solution provided by Functional Software Inc. More
            information is available here: https://sentry.io/privacy/. To opt
            out of Sentry tracking, see https://sentry.io/contact/gdpr/
          </p>
          <p>
            <strong>12.2. Posthog.</strong> Posthog is a product analytics
            service we use to capture usage data, which we use to maintain and
            improve the product.
          </p>
          ...
          <p>
            <strong>13.1. GitHub.</strong> GitHub is provided by GitHub, Inc.
            GitHub is a development platform to host and review code, manage
            projects, and build software. For more information on what data
          ...
          <p>
            Our Services are not intended for use by children age 13 and under
            for users in the United States, Belgium, Denmark, Portugal, Sweden
            and the United Kingdom, 14 and under in China, Spain, Bulgaria,
            Austria, Cyprus, Italy and Lithuania, 15 and under in Slovenia,
            Check Republic, Greece and France and 18 and under for India,
            Columbia, Indonesia, Egypt and 16 and under all other countries
            (“Children”).
          </p>
          <p>
          ...
          <p>
            ...
            you can make a complaint to us at data@commonknowledge.coop
          </p>
          <p>
