...
/**
 * Shows the value(s) currently driving the map colour for the selected boundary.
 * Only rendered when a choropleth data source is set and a boundary is selected.
 */
  ...
  return (
    <section className="rounded-lg border border-neutral-200 bg-neutral-50/80 p-3">
      ...
      {stat ? (
        ...
        <p className="text-sm text-muted-foreground">No value for this area</p>
      )}
    </section>
  );
}
