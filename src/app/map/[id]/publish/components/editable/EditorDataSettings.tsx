...
export default function EditorDataSettings() {
  ...
  useEffect(() => {
    ...
    // Use activeDataSourceId if available, otherwise use the first marker data source
    const currentTabId = activeDataSourceId || markerDataSourceIds[0];
  ...
  }, [activeDataSourceId, publicMap, getDataSourceById, markerDataSourceIds]);
  ...
  return (
    <>
      {markerDataSourceIds.length > 0 && (
        <Tabs
          value={activeDataSourceId || markerDataSourceIds[0]}
